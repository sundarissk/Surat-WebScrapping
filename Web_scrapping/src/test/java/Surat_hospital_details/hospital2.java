...
public class hospital2 {
	...
	public void hos_det() throws InterruptedException, IOException {
		...
		excelutil.setCellData("example3", 0, 2, "Contact No");
		excelutil.setCellData("example3", 0, 3, "Bed");
		excelutil.setCellData("example3", 0, 4, "Vocant");
		excelutil.setCellData("example3", 0, 5, "Ward");
		excelutil.setCellData("example3", 0, 6, "OZ");
		...
		for (int i = 1; i <= listlen; i++) {
			...
			excelutil.setCellData("example3", i, 2, contactdet);
			excelutil.setCellData("example3", i, 3, bedtot);
			excelutil.setCellData("example3", i, 4, vocanttot);
			excelutil.setCellData("example3", i, 5, wardto);
			excelutil.setCellData("example3", i, 6, totaloz);
	...
	public static void main(String[] args) throws InterruptedException, IOException {
		...
		hospital2 run = new hospital2(path);
		run.hos_det();
